...
// These tests assert highlighted (hljs span) output, so register the backend as
// the process default. See highlight-lazy.test.ts for the plain-until-loaded path.
